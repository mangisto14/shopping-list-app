...
export default function LiveActivityBanner() {
  ...
  return (
    <div
      className={`flex items-center gap-2 rounded-xl border border-gray-100 ${config.bg} px-4 py-2 shadow-sm transition-all`}
    >
      ...
      >
        ...
        <span className="font-medium text-gray-800">כרגע {current.item}</span>
      </span>
    </div>
  );
}
