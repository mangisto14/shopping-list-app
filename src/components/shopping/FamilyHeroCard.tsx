...
interface FamilyHeroCardProps {
  ...
  // ever renders this card without passing it.
  showInvite?: boolean;
}
...
export default function FamilyHeroCard({ listName, members, onInvite, inviteLabel, showInvite = true }: FamilyHeroCardProps) {
  return (
