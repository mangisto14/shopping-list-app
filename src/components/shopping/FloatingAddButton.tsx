...
export default function FloatingAddButton({ onClick }: FloatingAddButtonProps) {
  return (
    <button
      ...
      className="fixed left-1/2 -translate-x-1/2 z-50 w-16 h-16 rounded-full bg-blue-600 text-white shadow-[0_10px_24px_rgba(37,99,235,0.42),0_2px_6px_rgba(37,99,235,0.3)] hover:shadow-lg active:scale-95 transition-all duration-[180ms] flex items-center justify-center text-3xl font-light"
    >
      +
    </button>
  );
